...
const T = {
  es: {
    ...
    authNote: "Cada unidad incluye un código de 8 caracteres que acompaña a tu perfume. Tras la compra, podés asignar tu nombre o el de un destinatario para un obsequio, o bien, una frase que elijas, y luego podrás verificarlo en \"Verificar autenticidad\".",
  ...
  en: {
    ...
    heroSub: "Fragrances formulated and bottled in small batches. The code that comes with your bottle lets you verify it's original, and exclusive.",
    ...
    authNote: "Each unit includes an 8-character code that comes with your perfume. After purchase, you can assign your name, a recipient's name for a gift, or a phrase of your choice — then verify it under \"Verify authenticity\".",
    cartTitle: "Your cart",
